...
public class ImageView_func extends ImageView implements View.OnTouchListener {
    ...
    public ImageView_func(Context context) {
        super(context);
        GestureImageViewInit();
    }

    public ImageView_func(Context context, AttributeSet attrs) {
        super(context, attrs);
        GestureImageViewInit();
    }

    public ImageView_func(Context context, AttributeSet attrs, int defStyleAttr) {
