...
import com.example.android.order.order1;
import com.example.android.order.order2;
import com.example.android.order.order3;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        marketPref = sharedPref.getString("Choose_language", "zh");
        try {
            Resources res = getResources();
            DisplayMetrics dm = res.getDisplayMetrics();
            Configuration conf = res.getConfiguration();
            if (marketPref.equals("zh")) {
        ...
        sharedPref = PreferenceManager
                .getDefaultSharedPreferences(this);
        marketPref = sharedPref.getString("Choose_theme", "2");
        try {
            AppCompatDelegate.setDefaultNightMode(Integer.parseInt(marketPref));
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.Setting:
                ...
                return true;
            case R.id.Tutorial:
                Intent intent1 = new Intent(this, order1.class);
                startActivity(intent1);
                return true;
            case R.id.Feature_Request:
                Intent intent2 = new Intent(this, order2.class);
                startActivity(intent2);
                return true;
            case R.id.About_ClearScanner:
                Intent intent3 = new Intent(this, order3.class);
