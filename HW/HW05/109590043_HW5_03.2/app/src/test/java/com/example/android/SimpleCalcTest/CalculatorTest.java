...
public class CalculatorTest {
    ...
    public void powTwoNumbers() {
        double resultMul = mCalculator.pow(2, 2d);
        assertThat(resultMul, is(equalTo(4d)));
    }

    @Test
    public void powTwoNumbers1() {
        double resultMul = mCalculator.pow(2, 0d);
        assertThat(resultMul, is(equalTo(1d)));
    }

    @Test
    public void powTwoNumbers2() {
        double resultMul = mCalculator.pow(2, -1d);
        assertThat(resultMul, is(equalTo(0.5d)));
    }

    @Test
    public void test1() {
        double resultMul = mCalculator.pow(0, 2d);
        assertThat(resultMul, is(equalTo(0d)));
    }

    @Test
    public void test2() {
        double resultMul = mCalculator.pow(1, 3d);
        assertThat(resultMul, is(equalTo(1d)));
    }

    @Test
    public void test3() {
        double resultMul = mCalculator.pow(-4, 0d);
        assertThat(resultMul, is(equalTo(1d)));
    }
